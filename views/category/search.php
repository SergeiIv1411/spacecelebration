...
<div id="breadcrumb">
    <div class="container">
        <ul class="breadcrumb">
            <li><a href="/">Home</a></li>
            <?php if (isset($q)): ?>
            <li class="active">Найдено <?= $totalCount ?> результатов по запросу <?= Html::encode($q) ?></li>
            <?php endif; ?>
        </ul>
    </div>
</div>
                ...
                <div class="aside">
                    ...
                    <div class="product product-widget">
                        ...
                        <div class="product-body">
                            <h2 class="product-name"><a href="#">Товар 1</a></h2>
                    ...
                    <div class="product product-widget">
                        ...
                        <div class="product-body">
                            <h2 class="product-name"><a href="#">Товар 2</a></h2>
                                    ...
                                    <div class="product product-single">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <div class="product-btns">
                                                ...
                                                <button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Выбрать</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
