...
/**
 * ProductPostSearch represents the model behind the search form of `app\modules\admin\models\Product`.
 */
class ProductPostSearch extends Product
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'category_id', 'sale_percent', 'sort'], 'integer'],
